...
def convolve(image, K):
	...
	for y in np.arange(pad, iH + pad):
		for x in np.arange(pad, iW + pad):
			...
			# element-wise multiplication between the ROI
...
# laplacian to detect edge like regions
